...
import com.cloudo.wms.modules.cms.Setup;
import com.cloudo.wms.modules.core.models.Menu;
import com.cloudo.wms.modules.core.services.repositories.MenuRepository;
import com.cloudo.wms.service.AppService;
...
public class MenuService extends _BaseService<Menu> {
    ...
    @Autowired
    private com.cloudo.wms.modules.core.Setup coreSetup;
