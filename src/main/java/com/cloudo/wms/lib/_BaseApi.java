...
public abstract class _BaseApi<T extends _BaseEntity> {
	...
	public com.cloudo.wms.modules.core.models.File upload(@RequestPart(required = true) MultipartFile file, HttpServletRequest request)
		...
		com.cloudo.wms.modules.core.models.File f = new com.cloudo.wms.modules.core.models.File();
